...
import { Academies, Templates, Modules, Users, ModuleInstructors, AcademyIntegrations } from "@/lib/queries";
import { themeVars } from "@/lib/theme";
import PortalShell from "@/components/PortalShell";
import TrialBanner from "@/components/TrialBanner";
import ModuleForm from "@/components/ModuleForm";
import { createModule, deleteModule, assignInstructorToModule, unassignInstructorFromModule } from "@/lib/actions/modules";
...
export default async function ModulesLibraryPage({
  ...
  const integrations = await AcademyIntegrations.listByAcademy(academy.id);
  ...
  return (
    ...
    >
      ...
      <div className="app-card p-6 mb-8">
        ...
        <ModuleForm action={boundCreate} courseId={courseId} connectedProviders={connectedProviders} />
